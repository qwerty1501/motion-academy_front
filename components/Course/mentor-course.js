                    ...
                    <div className="grid grid-cols-3  mt-10 TeamCurseMaster" key={course.id}>
                        <div className=" relative col-span-2 ">
                            ...
                            <h1 className="title_hero text-white leading-relaxed   font-bold">
                                {course.free.mentor.full_name}
                            </h1>
                            <p className="capitalize leading-18 text-[16px] font-[500] text-[white] "  dangerouslySetInnerHTML={{ __html: course.free.mentor[`short_bio_${locale}`]}}/>
                            <p className="capitalize leading-18 text-[16px] font-[500] text-[white] mt-1"  dangerouslySetInnerHTML={{ __html: course.free.mentor[`bio_${locale}`]}}/>


                        </div>
                        <div className="DontworkingMaster_block ">
                            <img src={course.free.mentor.image} alt="Фото тренера" className="mentor-img"/>
                        </div>
                    </div>
                ) : (
